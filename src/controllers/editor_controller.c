                         ...
                         int *new_file_size)
{
    ...
    //               line_buf->new_lines_[curr_line + line_buf->gap_size_ - 2] + 1
    //         : 1;
    ...
    switch (ch)
    {
        ...
        case 10:
            ...
            *char_buf->ccur_ = '\n';
            char_buf->ccur_++;
            line_buf->new_lines_[line_buf->ccur_ - line_buf->new_lines_] =
                line_buf->ccur_ - line_buf->new_lines_;
            line_buf->ccur_++;
            // line_buf->new_lines_[line_buf->ccur_ - line_buf->new_lines_ + 1]
            // = 1;
            line_buf->gap_size_--;
            line_buf->size_++;
            *gap_size -= 1;
